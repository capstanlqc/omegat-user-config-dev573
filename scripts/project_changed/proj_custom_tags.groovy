...
switch (eventType) {
    case LOAD:
        ...
        Preferences.setPreference("tagValidation_customPattern", appliedTagFile.text.trim())
        Preferences.setPreference("tagValidation_removePattern", appliedFlaggedFile.text.trim())
        Preferences.save()
